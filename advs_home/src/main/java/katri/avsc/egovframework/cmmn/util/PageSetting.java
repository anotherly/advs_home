 ...
 *                prvePageNoOnPageList : 페이지 리스트의 이전 페이지 번호.
 *                nextPageNoOnPageList : 페이지 리스트의 다음 페이지 번호.
 ...
 *   수정일            수정자            수정내용
 *   ----------  --------    ---------------------------
 *   2016.12.15  JW          PaginationInfo.java를 기반으로 수정
 *
 * </pre>
 */
...
public class PageSetting {
	...
	private int prvePageNoOnPageList;
	private int nextPageNoOnPageList;
	...
	public int getPrvePageNoOnPageList(){
		prvePageNoOnPageList = (getFirstPageNoOnPageList() - getPageSize()) <= 0  ? 1 : (getFirstPageNoOnPageList() - getPageSize());
		return prvePageNoOnPageList;
	}
	
	public int getNextPageNoOnPageList(){
		System.out.println(getFirstPageNoOnPageList());
		System.out.println(getFirstPageNoOnPageList() + getPageSize());
		System.out.println(getLastPageNoOnPageList());
		nextPageNoOnPageList = (getFirstPageNoOnPageList() + getPageSize()) <= getLastPageNoOnPageList() ? getLastPageNoOnPageList() : (getFirstPageNoOnPageList() + getPageSize());
		
		return nextPageNoOnPageList;
	}
