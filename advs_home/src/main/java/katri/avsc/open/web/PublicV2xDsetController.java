 ...
 */
@Controller
@RequestMapping(value = "/open/v2x")
public class PublicV2xDsetController {
	...
	private static final Log LOG = LogFactory.getLog(PublicV2xDsetController.class.getName());
	...
	String scenarioCode1 = "V2XP";
	String scenarioCode2 = "V2XS";
	String scenarioCode3 = "V2XD";
	 ...
	 * @param model
	 * @return "Open_V2x_List"
	 * @exception Exception
	 */
	@RequestMapping(value = "Open_V2x_List.do")
	public String selectV2xList(@RequestParam Map<String, String> paramMap, ModelMap model,
...
//		}
		...
		if(bbs_seq.equals("2080") || bbs_seq.equals("2090") || bbs_seq.equals("2100")) {
			...
			List<?> v2xList = publicDsetService.selectPublicDsetList(paramMap);
			model.addAttribute("resultList", v2xList);
			...
			rtnStr = "agency/Agcy_V2x_List.tiles";
			...
			rtnStr =  "open/Open_V2x_List.tiles";
		}
		return rtnStr;
	}
	 ...
	 * @param paramMap - 조회할 정보가 담긴 Map
	 * @param model
	 * @return "Open_V2x_View"
	 * @exception Exception
	 */
	@RequestMapping(value = "Open_V2x_View.do")
	public String selectOpenV2xView(@RequestParam Map<String, String> paramMap, ModelMap model,
			HttpServletRequest request, HttpSession session) throws Exception {
		RequestURIModel uriModel = Util
				.getRequestURIModel(request.getRequestURI().replaceAll(request.getContextPath(), "")); // 메뉴를 구성하기위한 설정
		LOG.debug(" uriModel[" + uriModel.toString() + "]");
		...
		if(bbs_seq.equals("2080") || bbs_seq.equals("2090") || bbs_seq.equals("2100")) {
			...
			Map<String, String> v2xInfo = publicDsetService.selectPublicDsetInfo(paramMap);
			List<?> mxFileList = publicDsetService.selectMxFileList(paramMap);

			// v2xInfo.put("bContent", clobToString((Clob)v2xInfo.get("bContent")));
			// LOG.debug(" bContent["+v2xInfo.get("bContent")+"]");
			...
			model.addAttribute("v2xInfo", v2xInfo);
			...
			rtnStr = "agency/Agcy_V2x_View.tiles";
			...
			rtnStr = "open/Open_V2x_View.tiles";
		}
	 ...
	 * @param paramMap - 조회할 정보가 담긴 Map
	 * @param model
	 * @return "Open_V2x_Info"
	 * @exception Exception
	 */
	@RequestMapping(value = "Open_V2x_Info.do")
	public String selectOpenV2xInfo(@RequestParam Map<String, String> paramMap, ModelMap model, HttpServletRequest request, HttpSession session) throws Exception {
		...
		if(bbs_seq.equals("2080") || bbs_seq.equals("2090") || bbs_seq.equals("2100")) {
			...
			rtnStr = "agency/Agcy_V2x_Info.tiles";
			...
			rtnStr = "open/Open_V2x_Info.tiles";
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "Open_V2x_Inst.do")
	public String openV2xInsert(@RequestParam Map<String, String> paramMap, ModelMap model,
			HttpServletRequest request, HttpSession session) throws Exception {
		RequestURIModel uriModel = Util
				.getRequestURIModel(request.getRequestURI().replaceAll(request.getContextPath(), "")); // 메뉴를 구성하기위한 설정
		LOG.debug(" uriModel[" + uriModel.toString() + "]");
		...
		if(bbs_seq.equals("2080") || bbs_seq.equals("2090") || bbs_seq.equals("2100")) {
			...
			rtnStr = "agency/Agcy_V2x_Inst.tiles";
			...
			rtnStr = "open/Open_V2x_Inst.tiles";
		}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "Open_V2x_Inst_Process.do")
	public String openV2xInsertProcess(@RequestParam Map<String, String> paramMap, ModelMap model,
		...
		LOG.debug(" ########## Open_V2x_Inst_Process.do ###########");
		LOG.debug("       bbs_seq[" + paramMap.get("bbs_seq") + "]");
...
/////////////////////////////////////////////////////
		 ...
		 * model.addAttribute("result_insert", "ext"); return "open/Open_V2x_Process"; }
		...
		return "open/Open_V2x_Process.tiles";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "Open_V2x_Updt_Process.do")
	public String openV2xUpdateProcess(@RequestParam Map<String, String> paramMap, ModelMap model,
			MultipartHttpServletRequest multipartRequest, HttpSession session) throws Exception {
...
/////////////////////////////////////////////////////
		 ...
		 * get("customFile").isEmpty() && !bExt)+"]");
		 * model.addAttribute("result_insert", "ext"); model.addAttribute("bbs_seq",
		 * paramMap.get("bbs_seq")); return "open/Open_V2x_Process"; }
		 * LOG.debug("        Position Log[3]"); 파일 확장자 체크 : E
		 * if(!files.get("customFile").isEmpty() && bExt){
		 * LOG.debug("        Position Log[4]"); newFileNM = b_seq + "_";
		 * paramMap.put("file_size", String.valueOf(files.get("customFile").getSize()));
...
//		model.addAttribute("b_seq", paramMap.get("b_seq"));
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "Open_V2x_Delt_Process.do")
	public String openV2xDelete(@RequestParam Map<String, String> paramMap, ModelMap model, HttpSession session) throws Exception {
		...
		LOG.debug(" ########## Open_V2x_Delt_Process.do ###########");
		LOG.debug("    bbs_seq["+paramMap.get("bbs_seq")+"]");
		LOG.debug("   b_seq["+paramMap.get("b_seq")+"]");
