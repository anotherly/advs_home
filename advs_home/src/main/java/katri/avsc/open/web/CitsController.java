 ...
 */
@Controller
@RequestMapping(value = "/open/cits")
public class CitsController {
	...
	private static final Log LOG = LogFactory.getLog(CitsController.class.getName());
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "Open_Cits_List.do")
	public String selectCitsList(@RequestParam Map<String, String> paramMap, ModelMap model, HttpServletRequest request, HttpSession session) throws Exception {
		...
		return "open/Open_Cits_List.tiles";
	}
