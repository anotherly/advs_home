...
public class Mail_bak {

//	private static Log log = LogFactory.getLog(Mail_bak.class);
//
//	/**
//	 * 메일 전송 함수
...
//	 * @return
//	 */
//	public static void mailSend(String mailHost, String mailPort, String mailUser, String mailPwrd, String mailAdmn, String subject, String text) {
//
//		log.debug(" ########## mailSend() ###########");
//
//		// SMTP 서버 정보를 설정한다.
