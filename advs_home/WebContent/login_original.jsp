          ...
          <table summary="" class="">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <input type="text" class="w50p" id="user_id" name="user_id" value="한국전자통신연구원" title="user id" onkeyup="checkLength(this,20)">
                </td>
              </tr>
              <tr>
                <th class="border_l_none">USER NM</th>
                <td>
                  <input type="text" class="w50p" id="user_nm" name="user_nm" value="한국전자통신연구원" title="user name" onkeyup="checkLength(this,20)">
                </td>
              </tr>
              <tr>
                <th class="border_l_none">기관 ID</th>
                <td>
                  <input type="text" class="w50p" id="agcy_id" name="agcy_id" value="101" title="기관" onkeyup="checkLength(this,20)">
                </td>
              </tr>
              <tr>
                <th class="border_l_none">기관명</th>
                <td>
                  <input type="text" class="w50p" id="agcy_nm" name="agcy_nm" value="한국전자통신연구원" title="기관명" onkeyup="checkLength(this,20)">
                </td>
              </tr>
              <tr>
                <th class="border_l_none">권한 ID</th>
                <td>
                  <input type="text" class="w50p" id="auth_id" name="auth_id" value="105" title="권한" onkeyup="checkLength(this,20)">
                </td>
              </tr>
              <tr>
