                            ...
                            <div class="layout-content__inner">
                                ...
                                <div class="sch-area sch-area--box sch-area--gray">
                                    <div class="sch-form sch-form--row">
                                        <form action="">
                                            <label for="">
                                                <select id="searchType" name="searchType" title="자율주행 공지사항 검색대상 선택">
                                            ...
                                            <label for="">
                                                <input type="text" id="searchWord" name="searchWord" title="검색어 입력" placeholder="검색어를 입력해주세요." value="${searchWord }" onkeyup="injectionCheck(this)">
                                            </label>
                                ...
                                <div class="table-wrap">
                                    ...
                                    <table class="table-basic table-basic--col table-us_du_03_list">
                                        <caption>자율주행 공지사항 &gt; 자율주행 공지사항 테이블</caption>
                                        <colgroup>
                                            <col style="width:8%">
								            ...
								            <c:choose>
								              ...
								              <c:otherwise>
								                <c:forEach var="list" items="${resultList}" varStatus="status">
								                  <tr>
								                    <td>${list.bdwrSeq}</td>
								                    <td class="left"><a href="javascript:detail_View('${list.blbdDivCd}','${list.bdwrSeq}');">${list.bdwrTtlNm}</a></td>
								                    <c:choose>
