...
<!--                                  </div> -->
								...
								<div class="btn-wrap btn-row justify-center mt-30 mb-80">
									<button type="button" class="btn btn-width--l btn-color--white" onclick="location.href='/open/edge/Open_Edge_List.do?bbs_seq=2090' ">취소</button>
									<button type="button" class="btn btn-width--l btn-color--navy" onclick="location.href='javascript:fn_Insert(2090);' ">등록</button>
								</div>
