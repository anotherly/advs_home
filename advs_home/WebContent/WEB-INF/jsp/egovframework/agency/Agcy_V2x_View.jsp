...
<script type="text/javaScript" defer >
  ...
  $(document).ready(function() {
	...
	$('#offLine').on('click', function(){
		...
		c_form.bTitle.value = '${v2xInfo.bTitle}';
		c_form.dataType.value = '${v2xInfo.dataType}';
		c_form.dataTypeView.value = '${v2xInfo.dataTypeView}';
...
<input type="hidden" name="file_nm" id="file_nm" value="${v2xInfo.mxfile}"/>
							...
							<div class="layout-content__inner">
								...
								<div class="table-wrap">
									<table class="table-basic table-basic--row">
										<caption>협의체데이터 &gt; V2X시나리오 데이터셋 테이블</caption>
										<colgroup>
											<col style="width:15%">
											<col style="width:35%">
											<col style="width:15%">
