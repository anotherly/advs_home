  ...
  /* 등록 function */
	function fn_Save(bdwr, bbs) {
      ...
      if($('#bdwr_cts').val().length < 5){
			...
			document.listForm.action = "<c:url value='/open/dataset/Open_Dset_Updt_Process.do'/>";
  ...
  <div class="contWrap">
    ...
    <div class="contents">
            ...
            <tr>
              <td>
                <div class="fileBox lg">
                  <input type="file" name="file_info" id="file_info" class="uploadBtn">
      ...
      <div class="center mt20">
        ...
        <a href="/open/dataset/Open_Dset_Info.do?bdwr_seq=${bdwr_seq}&bbs_seq=${bbs_seq}" class="btn_gray btn_lg">취소</a>
      </div>
    </div>
    <!-- //contents -->
  </div>
