				...
				<div class="layout-container layout-full">
					<div class="layout-container__inner layout-container--row">
						<div class="lnb">
							...
							<div class="lnb-list">
	     						<div class="lnb-item is-active"><a href="/open/normal/Open_Normal_List.do?bbs_seq=3010">일반시나리오 데이터셋</a></div>
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<div class="ui-form">
															<label for="">
																<select name="selectDataType" id="selectDataType" title="수집차량모델 선택">
																	<c:choose>
...
<!--                                  </div> -->
								...
								<div class="btn-wrap btn-row justify-center mt-30 mb-80">
									<button type="button" class="btn btn-width--l btn-color--white" onclick="location.href='/open/normal/Open_Normal_List.do?bbs_seq=3010' ">취소</button>
									<button type="button" class="btn btn-width--l btn-color--navy" onclick="location.href='javascript:fn_Insert(3010);' ">등록</button>
								</div>
