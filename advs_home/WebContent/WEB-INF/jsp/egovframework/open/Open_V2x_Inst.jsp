							...
							<div class="layout-content__inner">
								...
								<div class="table-wrap">
									<table class="table-basic table-basic--row table--myUpload">
										<caption>공공데이터 &gt; V2X 데이터셋 테이블</caption>
										<colgroup>
											<col style="width:15%">
...
<!--                                  </div> -->
								...
								<div class="btn-wrap btn-row justify-center mt-30 mb-80">
									<button type="button" class="btn btn-width--l btn-color--white" onclick="location.href='/open/v2x/Open_V2x_List.do?bbs_seq=3030' ">취소</button>
									<button type="button" class="btn btn-width--l btn-color--navy" onclick="location.href='javascript:fn_Insert(3030);' ">등록</button>
								</div>
