  ...
  /* 등록 function */
	function fn_Insert(bbs) {
      ...
      if($('#bdwr_cts').val().length < 5){
			...
			document.listForm.action = "<c:url value='/open/dataset/Open_Dset_Inst_Process.do'/>";
  ...
  <div class="contWrap">
    ...
    <div class="contents">
      ...
      <div class="center mt20">
        ...
        <a href="/open/dataset/Open_Dset_List.do?bbs_seq=${bbs_seq}" class="btn_gray btn_lg">취소</a>
      </div>
    </div>
    <!-- //contents -->
  </div>
