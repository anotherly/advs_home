                      ...
                      <div class="layout-content">
                          <div class="layout-content__inner">
                              ...
                              <div class="table-wrap">
                                          ...
                                          <tr>
                                           ...
                                           <th scope="row">총 주행거리</th>
                                              <td>
                                                  <div class="ui-form ui-form-row align-center">
                                                      <div class="ui-form-block">
                                                          <input type="text" class="ui-input ui-form-width--r"  id="total_driving_dist" name="total_driving_dist" title="총 주행거리 입력" value="${drvgInfo.totalDrivingDist}" readonly=""/>
                                                      </div>
                                  ...
                                  <table class="table-basic table-basic--row mt-20 table-us_du_02_write--04">
                                      ...
                                      <tbody>
							              ...
							              <c:choose>
							                <c:when test="${drvStatus.index eq 0}">
							                  <tr>
							                    ...
							                    <input type="hidden" name="dist_mon_${drvStatus.count}" id="dist_mon_${drvStatus.count}" value="${drvList.drivingDistMon}" />
							                    <td><input type="text"class="ui-input ui-form-width--100" id="dist_${drvStatus.count}" name="dist_${drvStatus.count}" maxlength="7" style="ime-mode:disabled;" value="${drvList.autoDrivingDist}" onkeypress="return numbersonly(event, false, this, 7)" onkeyup="Javascript:dist_cal();"> Km</td>
							                    ...
							                    <c:forEach var="chgList" items="${chgList}" varStatus="chgStatus">
							                      <c:if test="${chgStatus.index eq drvStatus.index}">
							                        ...
							                        <input type="hidden" name="chng_mon_${chgStatus.count}" id="chng_mon_${chgStatus.count}" value="${chgList.ctrChangeMon}" />
							                        <td><input type="text" class="ui-input ui-form-width--100" id="chng_${chgStatus.count}" name="chng_${chgStatus.count}" maxlength="7" style="ime-mode:disabled;" value="${chgList.ctrChangeCnt}" onkeypress="return numbersonly(event, false, this, 7)" onkeyup="Javascript:chng_cal();"> 건</td>
							                ...
							                <c:otherwise>
							                  <tr>
							                    ...
							                    <c:forEach var="chgList" items="${chgList}" varStatus="chgStatus">
							                      <c:if test="${chgStatus.index eq drvStatus.index}">
							                        <td>${chgList.ctrChangeMonView}</td>
							                        <input type="hidden" name="chng_mon_${drvStatus.count}" id="chng_mon_${drvStatus.count}" value="${chgList.ctrChangeMon}" />
							                        <td><input type="text" class="ui-input ui-form-width--100" id="chng_${chgStatus.count}" name="chng_${chgStatus.count}"  maxlength="7" style="ime-mode:disabled;" value="${chgList.ctrChangeCnt}" onkeypress="return numbersonly(event, false, this, 7)" onkeyup="Javascript:chng_cal();" /> 건</td>
							                        <c:set var="chg_sum" value="${chg_sum + chgList.ctrChangeCnt}" />
							                      </c:if>
							                    </c:forEach>
							            ...
							            <tr>
											<td>합계</td>
											<td><input type="text" readonly="" class="ui-input ui-form-width--100" id="dist_s" name="dist_s" value="${drv_sum}" placeholder="자동계산입력" /> Km</td>
											<td>합계</td>
											<td><input type="text" readonly="" class="ui-input ui-form-width--100" id="chng_s" name="chng_s" value="${chg_sum}" placeholder="자동계산입력" /> 건</td>
							            </tr>
							            <tr>
                                           ...
                                           <td colspan="2">
                                               <div class="ui-form ui-form-row align-center">
                                                   <div class="ui-form-block">
                                                       <input type="text" class="ui-input ui-form-width--r" readonly="" id="auto_driving_dist" name="auto_driving_dist" maxlength="7" style="ime-mode:disabled;" value="${drvgInfo.autoDrivingDist}" onkeypress="return numbersonly(event, false, this, 7)" title="자율모드 주행거리 입력" />
                                                   </div>
                                                   <div class="ui-form-block ml-10">
                                                      km
                                                   </div>
                                           ...
                                           <td colspan="2">
                                               <div class="ui-form ui-form-row align-center">
                                                   <div class="ui-form-block">
                                                       <input type="text" class="ui-input ui-form-width--r" id="nomal_driving_dist" name="nomal_driving_dist" maxlength="7" style="ime-mode:disabled;" value="${drvgInfo.nomalDrivingDist}" onkeypress="return numbersonly(event, false, this, 7)" onkeyup="Javascript:nomal_cal();">
                                                   </div>
                                                   <div class="ui-form-block ml-10">
                                                       km
                                                   </div>
                                      ...
                                      <colgroup>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="ui-form">
                                                    	 <button type="button" class="btn btn-width--l btn-color--navy" onclick="javascript:fn_excelTempDown()">양식 다운로드</button>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                              ...
                              <div class="btn-wrap btn-row justify-center mt-30 mb-80">
                                  ...
                                  <button type="button" class="btn btn-width--l btn-color--navy" onclick="javascript:fn_Save('${drv_no}','${std_dt}');">등록</button>
                              </div>
                            </div>
                        </div>
                    </div>
