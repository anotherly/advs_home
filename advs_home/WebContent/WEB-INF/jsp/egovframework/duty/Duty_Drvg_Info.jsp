							...
							<div class="layout-content">
								<div class="layout-content__inner">
									...
									<h5 class="layout-content__subtit d-flex align-end">
										상세정보
										<button type="button"
											class="btn btn-width--m btn-color--navy ml-auto d-flex align-center justify-center"
											onclick="javascript:fn_Report('${drv_no}','${std_dt}');">
											<img src="/image/common/icon/icon-file--s.png" class="mr-10"
												alt="">보고서 생성
										</button>
									</h5>
									<div class="table-wrap">
										...
										<table
											class="table-basic table-basic--row mt-20 table-us_du_02_view--04">
											<caption>운행정보보고 &gt; 운행정보보고서 &gt; 운행정보보고서 상세정보 테이블</caption>
											<colgroup>
												<col style="width: 18%">
									...
									<div class="attachment-wrap">
										<h5 class="layout-content__subtit">첨부파일</h5>
										<table class="table-basic table-basic--row mt-20">
											<colgroup>
												<col style="width: 18%">
												<col style="width: auto">
											...
											<tbody>
												<tr>
													...
													<td colspan="3"><c:choose>
															<c:when test="${pdf_info.attachFile ne null}">
																<a href="javascript:void(0);" title="${pdf_info.attachFile} 첨부파일입니다" onclick="fn_Download('${pdf_info.attachFile}')">
																	<img src="/images/avsc/ico_file.png" alt="다운로드" class="file_icon" />
																	<i class="font_lGray">${pdf_info.attachFile}</i>
																</a>
															</c:when>
									...
									<div class="btn-wrap btn-row justify-center mt-30 mb-80">
										<button type="button"
											...
											onclick="javascript:fn_Delete('${drv_no}','${std_dt}');">삭제</button>
										<button type="button" class="btn btn-width--l btn-color--gray"
											onclick="javascript:fn_Update('${drv_no}','${std_dt}');">수정</button>
										<button type="button" class="btn btn-width--l btn-color--navy"
											onclick="javascript:fn_goList();">목록으로</button>
									</div>
								</div>
							</div>
						</div>
