...
<script src="/js/commonFunction.js"></script> <!-- 공통 script 함수를 정의 -->
...
function check(){
	...
	function fn_Insert() {
      ...
      if(trim(c_form.dist_1.value).length==0 || trim(c_form.dist_2.value).length==0 || trim(c_form.dist_3.value).length==0 || trim(c_form.dist_4.value).length==0 || trim(c_form.dist_5.value).length==0 ||trim(c_form.dist_6.value).length==0) {
				alert("월별 자율모드 주행거리를 모두 입력해주세요");
				c_form.dist_1.focus();
				return;
			}

      if(trim(c_form.chng_1.value).length==0 || trim(c_form.chng_2.value).length==0 || trim(c_form.chng_3.value).length==0 || trim(c_form.chng_4.value).length==0 || trim(c_form.chng_5.value).length==0 ||trim(c_form.chng_6.value).length==0) {
	...
	if(Number(c_form.chng_s.value) > 0 && !$("#excelFile").val()){
		...
		return;
	}else if(Number(c_form.chng_s.value) == 0 && $("#excelFile").val()){
  ...
  function dist_cal() {
    ...
    c_form.dist_s.value = dist_1 + dist_2 + dist_3 + dist_4 + dist_5 + dist_6;
  ...
  function nomal_cal(){
	  ...
	  c_form.total_driving_dist.value = intCheck(c_form.auto_driving_dist.value) + nomal;
  }
  ...
  function chng_cal() {
    ...
    c_form.chng_s.value = chng_1 + chng_2 + chng_3 + chng_4 + chng_5 + chng_6;
  }
...
function fn_update_date(){
    ...
    window.open('/common/Duty_Tpsv_Insdate_Popup.do?tmp_race_number='+tmpRaceNumber, 'tpsv_inst','left=200, top=100, width=498, height=428');
}
                  ...
                  <div class="layout-container__inner layout-container--row">
                      ...
                      <div class="layout-content">
                          <div class="layout-content__inner">
                              ...
                              <h5 class="layout-content__subtit d-flex">
                                  	운행정보보고서 등록
                              </h5>
                              <div class="table-wrap">
                                      ...
                                      <tbody>
                                          <tr>
									                  ...
									                  <c:choose>
									                    ...
									                    <c:otherwise>
									                      ...
									                      <c:forEach var="list" items="${code_tempoper }" varStatus="loop">
									                        <option value="${list.tmpNumber}|${list.tmpAgency}|${list.letterNum}|${list.insInitDateView}|${list.insInitDate}">${list.tmpNumber}</option>
									                      </c:forEach>
									                    </c:otherwise>
									                  </c:choose>
									                </select>
                                              ...
                                              <td>
                                              	<div class="ui-form ui-form-row align-center">
                                                   <div class="ui-form-block">
                                                      <input type="text" class="ui-input ui-form-width--r" readonly="" id="ins_init_date_view" name="ins_init_date_view"><input type="hidden" id="ins_init_date" name="ins_init_date">
                                             		</div>
                                             	</div>
                                              </td>
                                          </tr>
                                          <tr>
                                             ...
                                             <td colspan="3">
                                             	<div class="ui-form ui-form-row align-center">
                                                    <div class="ui-form-block">
                                             			<input type="text" class="ui-input ui-form-width--ul" readonly="" id="tmp_race_agency" name="tmp_race_agency">
                                             		</div>
                                             	</div>
                                             </td>
                                          </tr>
                                          <tr>
                                              ...
                                              <td>
                                                  <div class="ui-form ui-form-row align-center">
                                                      <div class="ui-form-block">
                                                          <input type="text" class="ui-input ui-form-width--r" id="stnd_dt" name="stnd_dt" title="기준일자 입력" maxlength="8"/>
                                                      </div>
                                                  </div>
                                              </td>
                                              ...
                                              <td>
                                                  <div class="ui-form ui-form-row align-center">
                                                      <div class="ui-form-block">
                                                          <input type="text" class="ui-input ui-form-width--r"  id="total_driving_dist" name="total_driving_dist" title="총 주행거리 입력" readonly=""/>
                                                      </div>
                                                      <div class="ui-form-block ml-10">
                                                          km
                                                      </div>
                                                  </div>
                                              </td>
                                  ...
                                  <table class="table-basic table-basic--row mt-20 table-us_du_02_write--04">
                                      <caption>운행정보보고 &gt; 운행정보보고서 &gt; 운행정보보고서 등록 테이블</caption>
                                      <colgroup>
                                          <col style="width:18%">
                                      ...
                                      <tbody>
                                          <tr>
                                              ...
                                              <td>
                                              	<select id="dist_mon_1" name="dist_mon_1" class="w100p">
								                  <option value="01">1월</option><option value="02">2월</option><option value="03">3월</option><option value="04">4월</option><option value="05">5월</option><option value="06">6월</option>
								                  <option value="07">7월</option><option value="08">8월</option><option value="09">9월</option><option value="10">10월</option><option value="11">11월</option><option value="12">12월</option>
								                </select>
											</td>
                                              <td>
                                                  <div class="ui-form ui-form-row align-center">
                                                      <div class="ui-form-block">
                                                          <input type="text" class="ui-input ui-form-width--100" id="dist_1" name="dist_1" maxlength="7" autocomplete="off" style="ime-mode:disabled;" onkeypress="return numbersonly(event, false, this, 7)" onkeyup="Javascript:dist_cal();" />  
                                                      </div>
                                                      <div class="ui-form-block ml-10">
                                                          km
                                                      </div>
                                              ...
                                              <td>
                                              	<select id="chng_mon_1" name="chng_mon_1" class="w100p">
								                  <option value="01">1월</option><option value="02">2월</option><option value="03">3월</option><option value="04">4월</option><option value="05">5월</option><option value="06">6월</option>
								                  <option value="07">7월</option><option value="08">8월</option><option value="09">9월</option><option value="10">10월</option><option value="11">11월</option><option value="12">12월</option>
								                </select>
											</td>
                                            <td><input type="text" class="ui-input ui-form-width--100" id="chng_1" name="chng_1" maxlength="7" autocomplete="off" style="ime-mode:disabled;" onkeypress="return numbersonly(event, false, this, 7)" onkeyup="Javascript:chng_cal();" /> 건</td>
                                          </tr>
                                          <tr>
                                              <td>
                                              	<select id="dist_mon_2" name="dist_mon_2" class="w100p">
								                  <option value="01">1월</option><option value="02">2월</option><option value="03">3월</option><option value="04">4월</option><option value="05">5월</option><option value="06">6월</option>
								                  <option value="07">7월</option><option value="08">8월</option><option value="09">9월</option><option value="10">10월</option><option value="11">11월</option><option value="12">12월</option>
								                </select>
											</td>
                                              <td>
                                                  <div class="ui-form ui-form-row align-center">
                                                      <div class="ui-form-block">
                                                          <input type="text" class="ui-input ui-form-width--100" id="dist_2" name="dist_2" maxlength="7" autocomplete="off" style="ime-mode:disabled;" onkeypress="return numbersonly(event, false, this, 7)" onkeyup="Javascript:dist_cal();" />
                                                      </div>
                                                      <div class="ui-form-block ml-10">
                                                          km
                                                      </div>
                                              ...
                                              <td>
                                              	<select id="chng_mon_2" name="chng_mon_2" class="w100p">
								                  <option value="01">1월</option><option value="02">2월</option><option value="03">3월</option><option value="04">4월</option><option value="05">5월</option><option value="06">6월</option>
								                  <option value="07">7월</option><option value="08">8월</option><option value="09">9월</option><option value="10">10월</option><option value="11">11월</option><option value="12">12월</option>
								                </select>
											</td>
                                            <td><input type="text" class="ui-input ui-form-width--100" id="chng_2" name="chng_2" maxlength="7" autocomplete="off" style="ime-mode:disabled;" onkeypress="return numbersonly(event, false, this, 7)" onkeyup="Javascript:chng_cal();"> 건</td>
                                          </tr>
                                          <tr>
                                              <td>
                                            	<select id="dist_mon_3" name="dist_mon_3" class="w100p">
								                  <option value="01">1월</option><option value="02">2월</option><option value="03">3월</option><option value="04">4월</option><option value="05">5월</option><option value="06">6월</option>
								                  <option value="07">7월</option><option value="08">8월</option><option value="09">9월</option><option value="10">10월</option><option value="11">11월</option><option value="12">12월</option>
								                </select>	
                                              </td>
                                              <td>
                                                  <div class="ui-form ui-form-row align-center">
                                                      <div class="ui-form-block">
                                                          <input type="text" class="ui-input ui-form-width--100" id="dist_3" name="dist_3" maxlength="7" autocomplete="off" style="ime-mode:disabled;" onkeypress="return numbersonly(event, false, this, 7)" onkeyup="Javascript:dist_cal();" />
                                                      </div>
                                                      <div class="ui-form-block ml-10">
                                                          km
                                                      </div>
                                              ...
                                              <td>
                                              	<select id="chng_mon_3" name="chng_mon_3" class="w100p">
								                  <option value="01">1월</option><option value="02">2월</option><option value="03">3월</option><option value="04">4월</option><option value="05">5월</option><option value="06">6월</option>
								                  <option value="07">7월</option><option value="08">8월</option><option value="09">9월</option><option value="10">10월</option><option value="11">11월</option><option value="12">12월</option>
								                </select>
								            </td>
                                            <td><input type="text" class="ui-input ui-form-width--100" id="chng_3" name="chng_3" maxlength="7" autocomplete="off" style="ime-mode:disabled;" onkeypress="return numbersonly(event, false, this, 7)" onkeyup="Javascript:chng_cal();" /> 건</td>
                                          </tr>
                                          <tr>
                                              <td>
                                              	<select id="dist_mon_4" name="dist_mon_4" class="w100p">
								                  <option value="01">1월</option><option value="02">2월</option><option value="03">3월</option><option value="04">4월</option><option value="05">5월</option><option value="06">6월</option>
								                  <option value="07">7월</option><option value="08">8월</option><option value="09">9월</option><option value="10">10월</option><option value="11">11월</option><option value="12">12월</option>
								                </select>
								             </td>
                                              <td>
                                                  <div class="ui-form ui-form-row align-center">
                                                      <div class="ui-form-block">
                                                          <input type="text" class="ui-input ui-form-width--100" id="dist_4" name="dist_4" maxlength="7" autocomplete="off" style="ime-mode:disabled;" onkeypress="return numbersonly(event, false, this, 7)" onkeyup="Javascript:dist_cal();" />
                                                      </div>
                                                      <div class="ui-form-block ml-10">
                                                          km
                                                      </div>
                                              ...
                                              <td>
                                              	<select id="chng_mon_4" name="chng_mon_4" class="w100p">
								                  <option value="01">1월</option><option value="02">2월</option><option value="03">3월</option><option value="04">4월</option><option value="05">5월</option><option value="06">6월</option>
								                  <option value="07">7월</option><option value="08">8월</option><option value="09">9월</option><option value="10">10월</option><option value="11">11월</option><option value="12">12월</option>
								                </select>
                                              </td>
                                              <td><input type="text" class="ui-input ui-form-width--100" id="chng_4" name="chng_4" maxlength="7" autocomplete="off" style="ime-mode:disabled;" onkeypress="return numbersonly(event, false, this, 7)" onkeyup="Javascript:chng_cal();" /> 건</td>
                                          </tr>
                                          <tr>
                                              <td>
                                              	<select id="dist_mon_5" name="dist_mon_5" class="w100p">
								                  <option value="01">1월</option><option value="02">2월</option><option value="03">3월</option><option value="04">4월</option><option value="05">5월</option><option value="06">6월</option>
								                  <option value="07">7월</option><option value="08">8월</option><option value="09">9월</option><option value="10">10월</option><option value="11">11월</option><option value="12">12월</option>
								                </select>
								              </td>
                                              <td>
                                                  <div class="ui-form ui-form-row align-center">
                                                      <div class="ui-form-block">
                                                          <input type="text" class="ui-input ui-form-width--100" id="dist_5" name="dist_5" maxlength="7" autocomplete="off" style="ime-mode:disabled;" onkeypress="return numbersonly(event, false, this, 7)" onkeyup="Javascript:dist_cal();" />
                                                      </div>
                                                      <div class="ui-form-block ml-10">
                                                          km
                                                      </div>
                                              ...
                                              <td>
                                              	<select id="chng_mon_5" name="chng_mon_5" class="w100p">
								                  <option value="01">1월</option><option value="02">2월</option><option value="03">3월</option><option value="04">4월</option><option value="05">5월</option><option value="06">6월</option>
								                  <option value="07">7월</option><option value="08">8월</option><option value="09">9월</option><option value="10">10월</option><option value="11">11월</option><option value="12">12월</option>
								                </select>
                                              </td>
                                              <td><input type="text" class="ui-input ui-form-width--100" id="chng_5" name="chng_5" maxlength="7" autocomplete="off" style="ime-mode:disabled;" onkeypress="return numbersonly(event, false, this, 7)" onkeyup="Javascript:chng_cal();" /> 건</td>
                                          </tr>
                                          <tr>
                                              <td>
                                              	<select id="dist_mon_6" name="dist_mon_6" class="w100p">
								                  <option value="01">1월</option><option value="02">2월</option><option value="03">3월</option><option value="04">4월</option><option value="05">5월</option><option value="06">6월</option>
								                  <option value="07">7월</option><option value="08">8월</option><option value="09">9월</option><option value="10">10월</option><option value="11">11월</option><option value="12">12월</option>
								                </select>
								              </td>
                                              <td>
                                                  <div class="ui-form ui-form-row align-center">
                                                      <div class="ui-form-block">
                                                          <input type="text" class="ui-input ui-form-width--100" id="dist_6" name="dist_6" maxlength="7" autocomplete="off" style="ime-mode:disabled;" onkeypress="return numbersonly(event, false, this, 7)" onkeyup="Javascript:dist_cal();" />
                                                      </div>
                                                      <div class="ui-form-block ml-10">
                                                          km
                                                      </div>
                                              ...
                                              <td>
                                              	<select id="chng_mon_6" name="chng_mon_6" class="w100p">
								                  <option value="01">1월</option><option value="02">2월</option><option value="03">3월</option><option value="04">4월</option><option value="05">5월</option><option value="06">6월</option>
								                  <option value="07">7월</option><option value="08">8월</option><option value="09">9월</option><option value="10">10월</option><option value="11">11월</option><option value="12">12월</option>
								                </select>
                                              </td>
                                              <td><input type="text" class="ui-input ui-form-width--100" id="chng_6" name="chng_6" maxlength="7" autocomplete="off" style="ime-mode:disabled;" onkeypress="return numbersonly(event, false, this, 7)" onkeyup="Javascript:chng_cal();" /> 건</td>
                                          </tr>
                                          <tr>
                                              <td>합계</td>
                                              <td><div class="ui-form ui-form-row align-center">
                                                    <div class="ui-form-block">
                                                      <input type="text" readonly="" class="ui-input ui-form-width--100" id="dist_s" name="dist_s" value="0" placeholder="자동계산입력" /> 
                                                    </div>
                                                    <div class="ui-form-block ml-10">
                                                        km
                                                    </div>
                                              ...
                                              <td>합계</td>
                                              <td><input type="text" readonly="" class="ui-input ui-form-width--100" id="chng_s" name="chng_s" value="0" placeholder="자동계산입력" /> 건</td>
                                          </tr>
                                          <tr>
                                              ...
                                              <td colspan="2">
                                                  <div class="ui-form ui-form-row align-center">
                                                      <div class="ui-form-block">
                                                          <input type="text" class="ui-input ui-form-width--r" id="auto_driving_dist" name="auto_driving_dist" maxlength="7" style="ime-mode:disabled;" onkeypress="return numbersonly(event, false, this, 7)" title="자율모드 주행거리 입력" />
                                                      </div>
                                                      <div class="ui-form-block ml-10">
                                                          km
                                                      </div>
                                              ...
                                              <td colspan="2">
                                                  <div class="ui-form ui-form-row align-center">
                                                      <div class="ui-form-block">
                                                          <input type="text" class="ui-input ui-form-width--r" id="nomal_driving_dist" name="nomal_driving_dist" maxlength="7" style="ime-mode:disabled;" onkeypress="return numbersonly(event, false, this, 7)" onkeyup="Javascript:nomal_cal();">
                                                      </div>
                                                      <div class="ui-form-block ml-10">
                                                          km
                                                      </div>
                              ...
                              <!-- TO_BE 입력 방법 -->
                              <div id="toBeTable" class="el-box el-box--gray el-box--border mt-20">
                                  <p class="el-essential font-s">※ 다운로드 한 양식의 파일명을 임의로 변경하여 업로드 할 경우 오류가 발생할 수 있습니다.</p>
                                  <table class="table-basic table-basic--row mt-20 table-us_du_02_write--05">
                                      ...
                                      <colgroup>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="ui-form">
                                                        <button type="button" class="btn btn-width--l btn-color--navy" onclick="javascript:fn_excelTempDown('${attachFile.attachFilename}')">양식 다운로드</button>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                        ...
                                                        <!-- <form action=""> -->
                                                            <div class="file">
                                                                <div class="file__input" id="file__input">
                                                                    <input class="file__input--file" id="excelFile" name="excelFile" type="file">
                                                                    <input class="file__upload--name" disabled="" placeholder="등록된 파일 없음">
                                                                    <label class="file__input--label" for="excelFile">파일찾기</label>
                                                                </div>
                                                            </div>
                                                        <!-- </form> -->
                                                    </div>
                                ...
                                <div class="btn-wrap btn-row justify-center mt-30 mb-80">
                                    <button type="button" class="btn btn-width--l btn-color--white" onclick="javascript:fn_List();">취소</button>
                                    <button type="button" class="btn btn-width--l btn-color--navy" onclick="javascript:fn_Insert();">등록</button>
                                </div>
...
<script type="text/javascript">
  ...
  $("#tb_plus").click(function () {
    var plus_cnt = intCheck($("#plus_cnt option:selected").val());
    for(var i=0; i < plus_cnt; i++) {
      ...
      $("input[id^='chg_date_d']").each(function() {
        var _this = this.id;
        $('#'+_this ).datepicker({
    				dateFormat: 'yy-mm-dd',
